...
urlpatterns = [
    ...
    path('password_reset/',auth_views.PasswordResetView.as_view(template_name='register/password_reset.html'),name='pass_reset'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='register/password-reset-confirm.html'),name='password_reset_confirm'),
    ...
    path('register/api/',include('register.api.urls'),name='register-api'),
